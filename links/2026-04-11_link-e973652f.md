...
date: 2026-04-11
tags: ["Agent runtime design", "Pi system architecture", "Technical book preface", "Design decisions"]
platform: web
author: null
summary: "This preface introduces the pi agent runtime design decisions, suitable for developers with TypeScript experience."
---
前言
...
标记说明
- 源码引用：
packages/agent/src/agent-loop.ts:155-232
— 文件路径 + 行号范围 - 取舍分析：每章末尾的"得到了什么 / 放弃了什么"段落
