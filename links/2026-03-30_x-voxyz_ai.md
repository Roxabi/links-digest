...
date: 2026-03-30
tags: ["AI Coding", "Claude Code", "gstack", "Superpowers", "Compound Engineering"]
platform: x
author: "@Voxyz_ai"
summary: "The article compares three Claude Code tools\u2014gstack, Superpowers, and Compound Engineering\u2014arguing that they serve distinct, complementary layers of AI development (planning, execution, and knowledge"
---
...
Claude Opus 4.6 has a 1 million token context window (currently in beta on the Claude Platform). For projects that fit within that window, you can load the full codebase and docs in one pass instead of feeding it piecemeal. That said, Anthropic's own harness post still emphasizes external state files (feature-list, init.sh, claude-progress.txt) as the primary coordination mechanism, not just raw context.
...
Clarify what you want. Use the 95% confidence prompt: "Interview me until you have 95% confidence about what I actually want, not what I think I should want."

/office-hours (gstack). Describe what you're building. Get challenged.

/plan-ceo-review (gstack). Product gate: is this worth building?

/plan-eng-review (gstack). Architecture gate: will this blow up later?

/ce:brainstorm (CE). Explore requirements and approaches, refine into a spec.

/ce:plan (CE). Research agents scan your project history, then produce a detailed implementation plan.

/ce:work (CE). Execute the plan with task tracking.

/ce:review (CE). Dynamic reviewer ensemble, minimum 6, scales with diff complexity.

/qa (gstack). Real browser, real clicks, real user testing on staging.

/ce:compound (CE). Record what you learned. Five subagents extract the lessons, write them to docs/solutions/.

Ship it. Next time you start at step 1, your plan phase already knows everything you learned this time.
...
Anthropic blog: anthropic.com/engineering/effective-harnesses-for-long-running-agents (Nov 26, 2025)
Anthropic blog 2: anthropic.com/engineering/harness-design-long-running-apps