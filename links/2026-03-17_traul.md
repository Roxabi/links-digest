...
date: 2026-03-17
tags: ["personal-intelligence", "local-first", "ai-agent", "vector-search", "sqlite"]
platform: github
author: null
summary: "Traul is a local-first Personal Intelligence Engine that indexes communication streams from multiple platforms into a searchable SQLite database to provide AI agents with cross-platform memory and"
---
# dandaka/traul

**URL:** https://github.com/dandaka/traul
**Description:** Personal Intelligence Engine — aggregates communication streams into a searchable local index
**Language:** TypeScript
**Stars:** 103 | **Forks:** 9
**License:** GNU Affero General Public License v3.0
**Topics:** cli, discord, gmail, local-first, personal-knowledge, search, slack, sqlite, telegram, typescript
...
**Requirements:** [Bun](https://bun.sh) v1.0+, SQLite with development headers, optionally [Ollama](https://ollama.co...