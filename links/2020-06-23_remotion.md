...
date: 2020-06-23
tags: ["video creation framework", "React video library", "programmatic video generation", "TypeScript framework"]
platform: github
author: "remotion-dev"
summary: "Remotion is a TypeScript framework that enables developers to create videos programmatically using React, leveraging web technologies like CSS, Canvas, SVG, and WebGL."
---
...
**Language:** TypeScript
**Stars:** 42716 | **Forks:** 2801
**License:** Other
**Topics:** react, video, javascript
