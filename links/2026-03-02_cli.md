...
date: 2026-03-02
tags: ["google workspace cli", "ai agent skills", "dynamic command generation", "rust tool"]
platform: github
author: "googleworkspace"
summary: "gws is a command-line tool for Google Workspace that dynamically generates commands and supports AI agent skills."
---
# googleworkspace/cli
...
**Language:** Rust
**Stars:** 24418 | **Forks:** 1237
**License:** Apache License 2.0
**Topics:** google-workspace, agent-skills, ai-agent, automation, cli, discovery-api, google-admin, google-api, google-calendar, google-chat, google-docs, google-drive, google-sheets, oauth2, rust, gemini-cli-extension
...
```bash
nix run github:googleworkspace/...