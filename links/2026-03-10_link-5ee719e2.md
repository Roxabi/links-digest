---
title: "Introduction - coss ui"
source: "https://coss.com/ui/docs"
date: 2026-03-10
tags: ["UI component library", "React components", "Base UI foundation", "Tailwind CSS styling"]
platform: web
author: "Cal.com"
summary: "coss ui is a modern React component library built on Base UI with Tailwind CSS styling, offering accessible components designed for developers to copy and own."
---
- Accordion
- Alert
- Alert Dialog
...
While shadcn/ui is now available with Base UI, coss ui isn't about re-implementing shadcn. It's about creating a coherent, opinionated UI system tailored to real production applications like Cal.com and coss.com. Our components, patterns, and evolutions go beyond base primitives, incorporating:
...
If you're migrating from shadcn/ui or Radix UI, we provide a comprehensive migration guide to make the transition smooth.
