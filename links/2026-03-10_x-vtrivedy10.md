...
source: "https://x.com/vtrivedy10/status/2031408954517971368?s=46"
date: 2026-03-10
tags: ["agent architecture", "model harness", "harness engineering", "AI infrastructure"]
platform: x
author: "@Vtrivedy10"
summary: "An agent is defined as a model plus a harness, which provides the necessary code, state, and tools to make model intelligence useful."
---
