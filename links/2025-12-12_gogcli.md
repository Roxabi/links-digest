...
source: "https://github.com/steipete/gogcli/releases/tag/v0.12.0"
date: 2025-12-12
tags: ["Google CLI tool", "Gmail command line", "Google Drive management", "Terminal productivity", "Google Workspace automation"]
platform: github
author: "steipete"
summary: "gogcli is a fast Go-based CLI tool for managing Gmail, Calendar, Drive, and other Google services directly from the terminal with JSON output and multi-account support."
---
# steipete/gogcli
