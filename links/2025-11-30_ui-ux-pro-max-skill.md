...
date: 2025-11-30
tags: ["AI design skill", "UI UX toolkit", "design system generator", "multi-platform design"]
platform: github
author: "nextlevelbuilder"
summary: "An AI-powered skill that provides design intelligence for building professional UI/UX across multiple platforms and frameworks."
---
...
**Language:** Python
**Stars:** 62991 | **Forks:** 6304
**License:** MIT License
**Topics:** ai-skills, antigravity, claude, claude-code, command-line, copilot, cursor-ai, html5, kiro, landing-page, mobile-ui, react, tailwindcss, ui-design, uikit, windsurf-ai, codex, qoder, trae
