...
date: 2026-04-01
tags: ["Claude Code", "Memory Management", "Anthropic", "Context Window", "Reverse Engineering"]
platform: x
author: "@troyhua"
summary: "This technical analysis reverse-engineers Claude Code\u0027s 7-layer memory architecture, explaining how it manages bounded context windows through tool result storage, microcompaction, and a background"
---
...
AND (tool calls since last extraction ≥ toolCallsBetweenUpdates
     OR no tool calls in the last assistant turn)
...
function hasMemoryWritesSince(messages, sinceUuid): boolean {
  ...
  // Returns true if main agent already saved memories
}
...
- [Testing Approach](feedback_testing.md) — Real DB tests only, no mocks after prod incident
- [User Profile](user_role.md) — Senior Go eng, new to React, focused on observability
...
Bad:  "Investigating the issue" (too vague)
Bad:  "Analyzed the branch diff" (past tense)
