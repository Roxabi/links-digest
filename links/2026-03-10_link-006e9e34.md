...
date: 2026-03-10
tags: ["command line interface", "test execution", "Playwright CLI", "debugging options"]
platform: web
author: "Microsoft"
summary: "Playwright offers a command line interface to run, debug, and manage tests with various filtering and configuration options."
---
Command line
...
--test-list  | Path to a file containing a list of tests to run. See test list for details. |
--test-list-invert  | Path to a file containing a list of tests to skip. See test list for details. |
...
accept a path to a test list file. This file should list tests in the format similar to the output produced in --list
mode.
