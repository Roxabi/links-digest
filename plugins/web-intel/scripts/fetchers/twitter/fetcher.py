...
from base import DEFAULT_MAX_CONTENT_SIZE, BaseFetcher, extract_id_from_url
...
from twitter.tweets import fetch_tweet_fxtwitter, fetch_tweet_syndication
            ...
            if tco_url:
                ...
                if resolved and resolved.get("success"):
                    ...
                    if resolved.get("is_twitter") and is_article_url(resolved_url):
                        ...
                        fx_result = fetch_tweet_fxtwitter(
                            tweet_id, max_content_size=max_content_size
                        )
