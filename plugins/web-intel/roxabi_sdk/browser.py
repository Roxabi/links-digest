...
def close_stealth(playwright: SyncPlaywright, context: SyncBrowserContext) -> None:
...
async def close_stealth_async(playwright: AsyncPlaywright, context: AsyncBrowserContext) -> None:
